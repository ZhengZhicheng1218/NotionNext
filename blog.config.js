...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi, 这里是Banned Band, 欢迎来到我们的空间。 🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Banned Band 禁止带乐队', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Banned Band', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-three-theta-19.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '乐队, 禁止带, Banned Band', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/514495240?spm_id_from=333.337.search-card.all.click', // B站主页
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'file:///C:/Users/ZhengZhicheng/Desktop/%E4%B9%90%E9%98%9F%E9%98%9F%E6%A0%87.jpg', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'file:///C:/Users/ZhengZhicheng/Desktop/%E4%B9%90%E9%98%9F%E9%98%9F%E6%A0%87.jpg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '乐队Blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || 'file:///C:/Users/ZhengZhicheng/Desktop/%E4%B9%90%E9%98%9F%E9%98%9F%E6%A0%87.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这里是Banned Band', // 站点描述，被notion中的页面描述覆盖
